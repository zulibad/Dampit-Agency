...
<head>
    ...
    <title>{{ config('app.name', 'Dampit Agency') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if(Auth::user()->akses == 'admin')
                            ...
                            @elseif(Auth::user()->akses == 'pelanggan')
                            <li class="nav-item">
                                <a href="{{ route('invoice.index') }}" class="nav-link">Daftar Tagihan</a>
                            </li>
                            @endif
